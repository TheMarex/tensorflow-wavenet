...
MODEL_DIR="s3://wavenet-data/models/wavenet/abstraction_publicenemy_5x2_2048_4s"
OUTPUT_DIR="s3://wavenet-data/outputs/wavenet/abstraction_publicenemy_5x2_2048_4s"
TRAIN_PARAMS="--data_dir=../training/abstraction --sample_size=64000 --logdir=${MODEL_DIR} --batch_size=3 --silence_threshold=0.1 --wavenet_params=../5_2048_double_wavenet_params.json --checkpoint_every 10000 --max_checkpoints=1000"
...
GENERATE_PARAMS="--samples=64000 --wavenet_params=../5_2048_double_wavenet_params.json --wav_seed ../generation/abstraction/primer_00.wav"
